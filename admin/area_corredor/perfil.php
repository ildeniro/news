                            ...
                            <form id="form_usuario" name="form_usuario" action="#" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div id="div_email" class="col-md-4 mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Ex.: example@gmail.com" required aria-required="true" value="<?= $usuario_email; ?>">
                                ...
                                <div class="d-flex justify-content-end gap-3">
                                    <button type="button" class="btn btn-secondary" onclick="window.location.href = '<?= PORTAL_URL; ?>admin/corredor'" aria-label="Cancelar cadastro">
                                        Cancelar
                                    </button>
...
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/area_corredor/perfil.js"></script>