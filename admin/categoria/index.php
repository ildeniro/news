                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <a href="<?= PORTAL_URL; ?>admin/categoria/cadastrar" class="btn btn-primary" aria-label="Cadastrar nova categoria">
                                        Nova Categoria
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            $result = $db->prepare("SELECT c.id, c.nome, c.data_cadastro, u.nome AS usuario  
                                                                    FROM eve_categorias AS c  
                                                                    INNER JOIN seg_usuarios AS u ON u.id = c.usuario_id 
                                                                    WHERE c.status = 1  
                                                                    ORDER BY c.nome");
                                            ...
                                            while ($categoria = $result->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                <tr>
                                                    <td><?= $cont; ?></td>
                                                    <td>
                                                        <a href="<?= PORTAL_URL; ?>admin/categoria/cadastrar/<?= $categoria['id']; ?>" class="d-flex align-items-center">
                                                            <div class="ms-2 ps-1">
                                                                <h6 class="fw-medium fs-14"><?= $categoria['nome']; ?></h6>
                                                            </div>
                                                        </a>
                                                    </td>
                                                    <td><?= $categoria['usuario']; ?></td>
                                                    <td><?= obterDataBRTimestamp($categoria['data_cadastro']); ?></td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <a class="dropdown-item" href="<?= PORTAL_URL; ?>admin/categoria/cadastrar/<?= $categoria['id']; ?>" aria-label="Editar Usuário">
                                                                <button title="Editar Usuário" class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                                                                    <i class="material-symbols-outlined fs-16 text-body">edit</i>
                                                                </button>
                                                            </a>
                                                            <a id="remover" class="dropdown-item" rel="<?= $categoria['id']; ?>" aria-label="Cancelar Usuário">
