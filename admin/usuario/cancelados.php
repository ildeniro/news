                    ...
                    <div class="card bg-white border-0 rounded-3 mb-4">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                                <h3 class="mb-0">Usuários Cancelados</h3>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <a id="ativar" class="dropdown-item" rel="<?= $usuario['id']; ?>" aria-label="Ativar Usuário">
                                                                <button title="Ativar Usuário" class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
...
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/usuarios/cancelados.js"></script>
