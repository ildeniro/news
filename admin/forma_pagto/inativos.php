...
// Filtros
$busca = $_GET['busca'] ?? '';
$status_filter = $_GET['status'] ?? 'inativos';
$where = "WHERE 1=1";
$params = [];
if ($busca) {
    $where .= " AND nome LIKE ?";
                    ...
                    <div class="card bg-white border-0 rounded-3 mb-4">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                                <h3 class="mb-0">Formas de Pagamento Inativas</h3>
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <a href="<?= PORTAL_URL; ?>admin/forma_pagto/cadastrar" class="btn btn-primary" aria-label="Cadastrar nova forma">
                                        Nova Forma
                                    </a>
                                </div>
                            </div>
